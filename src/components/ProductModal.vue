    ...
    <div v-if="isOpen" class="modal-overlay" @click.self="$emit('close')">
      <div class="product-modal">
        <div class="top-actions">
          ...
          <button class="action-btn close" @click="$emit('close')" title="Fechar">&times;</button>
        </div>
        ...
        <div class="modal-content" v-if="product">
          ...
          <div class="modal-details-col">
            ...
            <div class="price-row">
              ...
              <span class="dimensions-pill" v-if="product.dimensions">{{
                product.dimensions
              }}</span>
            </div>
            ...
            <div class="description-box">
              ...
              <p>
                {{
                  product.description ||
                  'Produto artesanal exclusivo, feito à mão com materiais de alta qualidade.'
                }}
              </p>
            </div>
